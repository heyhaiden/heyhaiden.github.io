...
const SkillsAndEducations = () => {
  ...
  const tabInfo = {
    'Skills': 'Ecological Consultancy, Biodiversity Management, Species Monitoring, Ecological Surveys, IoT Monitoring Development, GIS Mapping, Sustainable Design Consulting, Clerk of Works Services, Environmental Compliance Reports, Project Management',
